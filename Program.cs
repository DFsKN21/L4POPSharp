...
namespace L4POPSharp1
{
    class Program 
    {
        ...
        static void Main(string[] args)
        {
            ...
            // потік для філософів про початок обідання 
    ...
    public class Philosopher
    {
        ...
        private bool PickUp()
        {
            ...
            if (Monitor.TryEnter(this.LeftFork))
            {
                ...
                {
                    // якщо не вийшло обрати прау виделку тоді відпустити ліву
                    this.PDLeft();
                }
            }
